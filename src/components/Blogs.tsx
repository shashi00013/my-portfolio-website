...
export function Blogs() {
  return (
    <section className="py-32 bg-white border-t border-zinc-100 relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          ...
          <button className="flex items-center gap-2 font-bold text-sm text-indigo-600 hover:text-black transition-colors group">
            View All Posts
          ...
          {articles.map((article, idx) => (
            ...
            >
              <div className="p-8 border border-zinc-200 bg-zinc-50 rounded-[2.5rem] flex-grow flex flex-col group-hover:bg-black group-hover:border-black transition-all duration-500">
                ...
                <h3 className="text-2xl font-bold text-black mb-4 group-hover:text-white transition-colors">
                  {article.title}
                </h3>
                
                <p className="text-zinc-500 mb-8 flex-grow group-hover:text-zinc-400 transition-colors">
                  {article.excerpt}
                </p>
